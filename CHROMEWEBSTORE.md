...
- Preserved the complete question section on supported Zhihu answer links while continuing to export only the requested answer

### 0.3.2 — 2026-09-12

- Prevented viewport-sized sections and spacing from expanding with the PDF page
- Added focused export for supported Zhihu answer links while excluding unrelated answers and fixed interface elements
- Bounded dynamic-feed preparation and added consecutive layout-stability checks
- Improved errors for changing layouts, inaccessible page styles, export limits, and unverifiable multi-page output
- Added export-logic regression tests and verified one-page output on the project website and DeepSeek Harness at two viewport sizes
